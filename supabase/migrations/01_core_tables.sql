-- ============================================================================
-- FARMERS BOOT - CORE TABLES
-- ============================================================================
-- This migration creates the core database tables for the Farmers Boot application
-- Version: 01_core_tables
-- ============================================================================

-- Record this migration
INSERT INTO public.schema_migrations (version, description)
VALUES ('01_core_tables', 'Create core database tables')
...
-- Add farm_id foreign key to profiles
...
CREATE TABLE IF NOT EXISTS public.livestock (
    ...
    birth_date date,
    weight_kg numeric,
    status text DEFAULT 'active' CHECK (status IN ('active', 'healthy', 'sick', 'sold', 'deceased', 'pregnant', 'quarantine')),
    purchase_date date,
    purchase_price numeric,
    parent_id uuid REFERENCES public.livestock(id) ON DELETE SET NULL,
    created_at timestamp with time zone DEFAULT timezone('utc'::text, now()) NOT NULL,
    updated_at timestamp with time zone DEFAULT timezone('utc'::text, now()) NOT NULL,
    metadata jsonb DEFAULT '{}'::jsonb
);
...
-- ============================================================================
-- RATE LIMITING (FREE - Uses Supabase Database)
-- ============================================================================

-- Rate limits table for tracking API requests
