...
const BULK_OPERATIONS: BulkOperation[] = [
  {
    ...
    apiEndpoint: '/functions/v1/bulk-delete',
    method: 'DELETE',
  },
  {
    id: 'update-status',
    ...
    apiEndpoint: '/functions/v1/bulk-update',
    method: 'PUT',
  },
  {
    id: 'export-csv',
    ...
    color: 'green',
    requiresConfirmation: false,
    apiEndpoint: '/functions/v1/bulk-export',
    method: 'POST',
  },
  {
    id: 'archive',
    ...
    color: 'yellow',
    requiresConfirmation: true,
    apiEndpoint: '/functions/v1/bulk-archive',
    method: 'PUT',
  },
  {
    id: 'restore',
    ...
    color: 'purple',
    requiresConfirmation: true,
    apiEndpoint: '/functions/v1/bulk-restore',
    method: 'PUT',
  },
  {
    id: 'assign-category',
    ...
    apiEndpoint: '/functions/v1/bulk-assign',
    method: 'PUT',
  },
];
