...
import { DashboardSkeleton, StatCardSkeleton, FarmGridSkeleton } from '../components/ui/Skeleton';
...
export default function Dashboard() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-green-50 to-blue-50 p-4 sm:p-6">
        <DashboardSkeleton />
      </div>
    );
  }
        ...
        >
          ...
          {activeTab === 'weather' && (
            <div className="space-y-6">
              ...
              {farmData && <WeatherAnalytics farmId={farmData.id} />}

              {/* Enhanced Farm Calendar */}
              {farmData && (
                <ErrorBoundary>
                  <EnhancedFarmCalendar farmId={farmData.id} />
                </ErrorBoundary>
              )}
              ...
              {farmData && (
                <ErrorBoundary>
                  <WeatherCalendar farmId={farmData.id} />
                </ErrorBoundary>
              )}
            </div>
          )}
                      ...
                      <div>
                        ...
                        <p
                          className={`font-medium ${
                            isOverdue(task.due_date, task.status) ? TEXT_RED_600 : 'text-gray-900'
                          }`}
                        >
