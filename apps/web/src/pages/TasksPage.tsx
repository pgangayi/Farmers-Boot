  ...
  const stopTimer = async (task: ExtendedTask) => {
    ...
    try {
      if (logId) {
        ...
        await apiClient.post('tasks_time_logs', { task_id: task.id, end_time: now });
      }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[{ label: 'Dashboard', href: '/dashboard' }, { label: 'Tasks' }]}
            className="mb-0"
          />
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {viewMode === 'overview' && (
          <TaskOverview
            ...
            onTaskSelect={task => setEditingTask(task as unknown as ExtendedTask)}
          />
        )}
        ...
        {/* Analytics Tab */}
        {viewMode === 'analytics' && <TaskAnalytics farmId={currentFarm?.id} />}
