...
type TabValues = 'overview' | 'list' | 'health' | 'breeding' | 'feed' | 'activities';
...
const TABS: { value: TabValues; label: string; icon: any }[] = [
  ...
  { value: 'activities', label: 'Farming Activities', icon: Calendar },
];
