...
// Query key constant
const QUERY_KEY_FIELDS = ['fields'] as const;
...
export function FieldsPage() {
  ...
  const createFieldMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: QUERY_KEY_FIELDS });
  ...
  const deleteFieldMutation = useMutation({
    ...
    onSuccess: () => queryClient.invalidateQueries({ queryKey: QUERY_KEY_FIELDS }),
  });
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <LoadingErrorContent
          ...
          onRetry={() => queryClient.invalidateQueries({ queryKey: QUERY_KEY_FIELDS })}
