...
const FORM_ELEMENTS = 'input, button, select, textarea';
...
test.describe('Responsive Design', () => {
  ...
  test('should have accessible forms on all screen sizes', async ({ page }) => {
    ...
    const mobileFormElements = page.locator(FORM_ELEMENTS);
    ...
    const tabletFormElements = page.locator(FORM_ELEMENTS);
    ...
    const desktopFormElements = page.locator(FORM_ELEMENTS);
